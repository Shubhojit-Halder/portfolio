  ...
  return (
    <div className={styles.main}>
      ...
      <div className={styles.content}>
        ...
        placeat accusantium dolores commodi veritatis cupiditate, suscipit aut
        delectus quibusdam, doloremque et pariatur aliquam laudantium maxime
        repellendus velit autem quae
      </div>
    </div>
  );
};
